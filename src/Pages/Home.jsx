...
function Home() {
    ...
    // Fetch data from API
    useEffect(() => {
        axios.get('http://127.0.0.1:8000/api/membersByFilter')
            .then(res => {
                // Paginated API: members array is inside res.data.data.data
    ...
    //     // Fetch all members instead of a specific member
    ...
    //             setMembers(response.data.data || response.data); // Handle different response structures
    //             setLoading(false);
    //         })
    //         .catch((err) => {
    ...
    //             setLoading(false);
    //         });
    // }, []); // Empty dependency array since we're fetching all members
                                    ...
                                    <div className="col-lg-4 col-md-6 mb-4" key={member.id}>
                                        <div className="feature-box">
                                            ...
                                            <div className="feature-box-icon me-3">
                                                <img
                                                    src={member.profile_img || "https://via.placeholder.com/80"}
                                            ...
                                            <div className="member-info text-white">
                                                <h5 className="text-white mb-2">{member.full_name}</h5>
            ...
            <section className="testimonial bg-lightgrey">
                <div className="container">
                    <div className="section-title w-lg-60 m-auto text-center pb-5">
                        ...
                        <h2 className="mb-1">WHAT PEOPLES'S SAYS ABOUT <span className="pink">BNI</span></h2>
